...
-- Cost: ~3-4 credits (down from 3-5)
-- Output: ~250 rows (daily aggregates)
-- Changes: Removed min_trade_usd
-- ============================================================================
...
token_bought_trades AS (
    ...
    WHERE dt.block_date >= CURRENT_DATE - INTERVAL '21' DAY
...
SELECT
    ...
    MAX(amount_usd) as max_trade_usd,  -- KEPT for whale detection
